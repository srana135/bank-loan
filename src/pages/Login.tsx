      ...
      <div className="w-full max-w-5xl grid grid-cols-1 lg:grid-cols-2 gap-0 lg:gap-0 rounded-2xl overflow-hidden shadow-xl border border-border/50">
        ...
        <div className="hidden lg:flex flex-col justify-center p-10 hero-gradient text-primary-foreground relative overflow-hidden">
          <div
            ...
            style={{
              backgroundImage:
                "radial-gradient(circle at 20% 80%, hsl(42 85% 52% / 0.3) 0%, transparent 50%), radial-gradient(circle at 80% 20%, hsl(210 40% 98% / 0.15) 0%, transparent 50%)",
            }}
          />
          <div className="relative z-10 space-y-8">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="font-heading text-2xl font-bold">Bank Loan Management</h1>
            ...
            <div className="space-y-1">
              ...
              <p className="text-sm text-primary-foreground/70 max-w-sm">
                Streamlined loan management system for efficient tracking, recovery, and branch oversight.
              </p>
            </div>
          ...
          {mode === "login" && (
            <form onSubmit={loginForm.handleSubmit(onLogin)} className="space-y-4">
              ...
              <div className="flex flex-col gap-2 text-center text-sm pt-2">
                ...
                <button
                  type="button"
                  onClick={() => setMode("register-request")}
          ...
          {mode === "register-request" && (
            <form onSubmit={regForm.handleSubmit(onRegRequest)} className="space-y-3">
              <div className="space-y-1.5">
                ...
                {regForm.formState.errors.requestedUserId && (
                  <p className="text-xs text-destructive">{regForm.formState.errors.requestedUserId.message}</p>
                )}
              </div>
              <div className="space-y-1.5">
                ...
                {regForm.formState.errors.fullName && (
                  <p className="text-xs text-destructive">{regForm.formState.errors.fullName.message}</p>
                )}
              </div>
              <div className="space-y-1.5">
              ...
              <div className="space-y-1.5">
                ...
                {regForm.formState.errors.mobile && (
                  <p className="text-xs text-destructive">{regForm.formState.errors.mobile.message}</p>
                )}
              </div>
              <div className="space-y-1.5">
                <Label className="text-xs">Requested Role</Label>
                <select
                  {...regForm.register("requestedRole")}
