...
const LoanManagement = () => {
  ...
  const filteredLoans = useMemo(() => {
    if (!allLoans) return [];
    let loans = applyFilters(allLoans, filters, search, _loanRecoveryMapEarly);
    ...
    return loans;
  }, [allLoans, filters, search, adminBranchFilter, userRole, sortKey, sortDir, _loanRecoveryMapEarly]);
